...
acs12 %>% 
  ...
  summarize(number = n()) 
#show how many individuals falls in each group(group by gender, level of income and age)
...
#too bad. think of defining income to be categorical? set different levels of income? say <$10,000, $10,001~20,000 etc..
```
